        ...
        <form action="{{ route('garment_categories.update', $garmentCategory->id) }}" method="POST"
            ...
            <div class="mb-4">
                ...
                <input type="text"
                    ...
                    id="name" name="name" value="{{ old('name', $garmentCategory->name) }}" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea
                    class="form-input w-full border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    id="description" name="description" rows="3">{{ old('description', $garmentCategory->description) }}</textarea>
            </div>
